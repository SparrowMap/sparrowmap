...
// 🗺️ The basemap (self-hosted vector tiles, frame pump, raster watchdog) lives
// in /static/basemap.js so driving mode, aim, ipcamera and planes draw the SAME
// map as this page. The Carto raster proxy is only the fallback there; on
// 2026-09-11 every page still calling it directly showed Carto's "API KEY
// REQUIRED" watermark while this one did not. `?raster=1` still forces Carto.
sparrowBasemap(map);
